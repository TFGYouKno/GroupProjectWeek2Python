class Parking_Garage():
    '''
    Welcome to Fucklechuck's Parking Garage!
    '''
    ...
    def take_ticket(self):
        ticket_type = input(f'welcome to Fucklechucks Parking! Would you like $70 peasant parking or $120 premium parking?')
    ...
    def runner(self):
        while True:
            ...
            if check_point == "entering":
                ...
                print("Dude, it is not rocket surgery. You coming or going?")
user = Parking_Garage()
user.runner()